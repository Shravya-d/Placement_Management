...
exports.sendInterviewScheduledEmail = async (student, companyName) => {
    await sendEmail({
        email: student.email,
        subject: 'Interview Scheduled - PlacementSync',
        message: `Dear ${student.name},\n\nYour interview for ${companyName} has been scheduled successfully.\n\nPlease log in to PlacementSync and check your dashboard for the interview details.\n\nBest Regards,\nPlacement Cell\nPlacementSync`
    });
};
