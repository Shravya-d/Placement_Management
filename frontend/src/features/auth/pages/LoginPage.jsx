        ...
        <div className="md:w-1/2 p-8 md:p-12 bg-gradient-to-br from-surface to-surface-raised flex flex-col justify-center relative overflow-hidden border-r border-border/30">
          ...
          <div ref={leftPanelRef} className="relative z-10 space-y-8">
            <div className="flex items-center space-x-3 mb-12">
              <div className="w-10 h-10 rounded-2xl bg-brand-violet flex items-center justify-center shadow-lg shadow-brand-violet/20">
                <span className="font-bold text-light text-xl">P</span>
              </div>
              <span className="text-xl font-bold tracking-tight text-light">PlacementSync</span>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold text-light tracking-tight leading-tight">
              Launch your <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-violet to-brand-iris">
                Career
              </span> today.
            </h1>
